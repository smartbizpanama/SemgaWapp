-- =============================================
-- Script: Actualizar stored procedures para manejar ProvinciaTrabajo
...
CREATE PROCEDURE [dbo].[spGestionSocios_CrearSocio]
    ...
    @ProvinciaTrabajoCode INT = NULL -- Code de tbProvincias
AS
BEGIN
    SET NOCOUNT ON;
    ...
    INSERT INTO tbAsociados (
        ...
        @DistritoResidencia, @CorregimientoResidencia, @DireccionResidencia, @ProvinciaTrabajo,
        @DistritoTrabajo, @CorregimientoTrabajo, @DireccionTrabajo, @NivelEstudio, @Profesion,
        GETDATE(), @UsuarioCrea, 0, @LugarTrabajo, @Ocupacion, @PaisTrabajo, @ProvinciaTrabajoCode
    );
...
BEGIN
    ...
    SET
        ...
        ProvinciaTrabajo = @ProvinciaTrabajoCode
...
PRINT '✅ Todos los stored procedures actualizados para manejar ProvinciaTrabajo'
GO
