-- =============================================
-- Trigger de Auditoría MEJORADO para tbAsociados
-- Captura todos los cambios: INSERT, UPDATE, DELETE
-- Incluye descripciones de IDs en lugar de solo números
-- =============================================
...
PRINT 'Trigger tr_Auditoria_tbAsociados MEJORADO creado exitosamente'
PRINT 'Incluye descripciones de IDs: TipoAsociado, NivelEstudio, Profesion, LugarTrabajo, Ocupacion, Pais, Provincia, Distrito, Corregimiento, Usuario'
PRINT 'Formato: "Descripción (ID)"'
GO
