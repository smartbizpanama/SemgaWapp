...
/****** Object: StoredProcedure [dbo].[spAuxiliares_EliminarAuxiliar_ConAuditoria] ******/
SET ANSI_NULLS ON
GO
...
-- Description: Elimina un auxiliar con auditoría completa del equipo
-- =============================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Actualizar el auxiliar con eliminación lógica y auditoría
        UPDATE tbAuxiliares 
        SET 
            snEliminado = 1,
