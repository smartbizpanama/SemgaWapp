-- ============================================================
-- tbCuentas_LogSaldos - SemgaWapp (Cooperativa Coopsemga)
-- Log de cambios de saldo de cuentas contables.
-- Usada por spCuentas_CambiarSaldo.
-- ============================================================
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'tbCuentas_LogSaldos')
BEGIN
