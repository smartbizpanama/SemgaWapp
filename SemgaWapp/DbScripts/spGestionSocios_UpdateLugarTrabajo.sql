-- =============================================
-- ACTUALIZAR STORED PROCEDURES PARA LUGAR DE TRABAJO
-- =============================================

USE SegmaDB;
GO

-- Actualizar spGestionSocios_ObtenerSocios para incluir información de empresa
...
-- Actualizar spGestionSocios_ObtenerSocioPorNumero para incluir información de empresa
...
-- Actualizar spGestionSocios_CrearSocio para manejar Code de empresa
...
-- Actualizar spGestionSocios_ActualizarSocio para manejar Code de empresa
...
PRINT 'Stored procedures actualizados exitosamente para manejar Code de empresa';
