-- =============================================
-- STORED PROCEDURES PARA GESTIÓN DE SOCIOS CON SESSION TRACKING
-- =============================================

-- Procedimiento para crear un nuevo socio con session tracking
...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO tbAsociados (
            ...
            @DistritoResidencia, @CorregimientoResidencia, @DireccionResidencia, @ProvinciaTrabajo,
            @DistritoTrabajo, @CorregimientoTrabajo, @DireccionTrabajo, @LugarTrabajo, @Ocupacion,
            @NivelEstudio, @Profesion, @PaisResidencia, @PaisTrabajo, GETDATE(), @Usuario, 
            @IdSession, 0
        );
...
-- Procedimiento para actualizar un socio existente con session tracking
...
BEGIN
    ...
    BEGIN TRY
        ...
        UPDATE tbAsociados SET
            ...
            PaisTrabajo = @PaisTrabajo, FechaModificacion = GETDATE(), UsuarioModifica = @Usuario,
...
-- Procedimiento para eliminar un socio con session tracking
ALTER PROCEDURE [dbo].[spGestionSocios_EliminarAsociado]
    @NumeroAsociado INT,
    @UsuarioElimina INT,
...
PRINT 'Stored Procedures actualizados con Session Tracking:'
