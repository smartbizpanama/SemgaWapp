-- =============================================
-- Trigger de Auditoría MEJORADO para tbBeneficiarios
...
BEGIN
    ...
    BEGIN
        ...
        SELECT 
            ...
            ',"NumeroAsociado":"' + dbo.fnAuditoria_ObtenerAsociado(ISNULL(NumeroAsociado, 0)) + ' (' + CAST(ISNULL(NumeroAsociado, 0) AS NVARCHAR(10)) + ')"' +
            ',"Nombre":"' + ISNULL(Nombre, '') + '"' +
            ',"Apellido":"' + ISNULL(Apellido, '') + '"' +
            ',"TipoIdentificacion":"' + dbo.fnAuditoria_ObtenerTipoDocumento(ISNULL(TipoIdentificacion, '')) + ' (' + ISNULL(TipoIdentificacion, '') + ')"' +
            ',"NumeroIdentificacion":"' + ISNULL(NumeroIdentificacion, '') + '"' +
            ',"IDParentezco":"' + dbo.fnAuditoria_ObtenerParentesco(ISNULL(IDParentezco, 0)) + ' (' + CAST(ISNULL(IDParentezco, 0) AS NVARCHAR(10)) + ')"' +
            ...
            ',"FechaHoraCrea":"' + ISNULL(CONVERT(NVARCHAR(19), FechaHoraCrea, 103) + ' ' + CONVERT(NVARCHAR(8), FechaHoraCrea, 108), '') + '"' +
            ',"UsuarioModifica":"' + dbo.fnAuditoria_ObtenerUsuario(ISNULL(UsuarioModifica, 0)) + ' (' + CAST(ISNULL(UsuarioModifica, 0) AS NVARCHAR(10)) + ')"' +
            ',"FechaModifica":"' + ISNULL(CONVERT(NVARCHAR(19), FechaModifica, 103) + ' ' + CONVERT(NVARCHAR(8), FechaModifica, 108), '') + '"' +
    ...
    BEGIN
        ...
        SELECT 
            ...
            ',"NumeroAsociado":"' + dbo.fnAuditoria_ObtenerAsociado(ISNULL(d.NumeroAsociado, 0)) + ' (' + CAST(ISNULL(d.NumeroAsociado, 0) AS NVARCHAR(10)) + ')"' +
            ',"Nombre":"' + ISNULL(d.Nombre, '') + '"' +
            ',"Apellido":"' + ISNULL(d.Apellido, '') + '"' +
            ',"TipoIdentificacion":"' + dbo.fnAuditoria_ObtenerTipoDocumento(ISNULL(d.TipoIdentificacion, '')) + ' (' + ISNULL(d.TipoIdentificacion, '') + ')"' +
            ',"NumeroIdentificacion":"' + ISNULL(d.NumeroIdentificacion, '') + '"' +
            ',"IDParentezco":"' + dbo.fnAuditoria_ObtenerParentesco(ISNULL(d.IDParentezco, 0)) + ' (' + CAST(ISNULL(d.IDParentezco, 0) AS NVARCHAR(10)) + ')"' +
            ...
            ',"FechaHoraCrea":"' + ISNULL(CONVERT(NVARCHAR(19), d.FechaHoraCrea, 103) + ' ' + CONVERT(NVARCHAR(8), d.FechaHoraCrea, 108), '') + '"' +
            ',"UsuarioModifica":"' + dbo.fnAuditoria_ObtenerUsuario(ISNULL(d.UsuarioModifica, 0)) + ' (' + CAST(ISNULL(d.UsuarioModifica, 0) AS NVARCHAR(10)) + ')"' +
            ',"FechaModifica":"' + ISNULL(CONVERT(NVARCHAR(19), d.FechaModifica, 103) + ' ' + CONVERT(NVARCHAR(8), d.FechaModifica, 108), '') + '"' +
            ...
            ',"NumeroAsociado":"' + dbo.fnAuditoria_ObtenerAsociado(ISNULL(i.NumeroAsociado, 0)) + ' (' + CAST(ISNULL(i.NumeroAsociado, 0) AS NVARCHAR(10)) + ')"' +
            ',"Nombre":"' + ISNULL(i.Nombre, '') + '"' +
            ',"Apellido":"' + ISNULL(i.Apellido, '') + '"' +
            ',"TipoIdentificacion":"' + dbo.fnAuditoria_ObtenerTipoDocumento(ISNULL(i.TipoIdentificacion, '')) + ' (' + ISNULL(i.TipoIdentificacion, '') + ')"' +
            ',"NumeroIdentificacion":"' + ISNULL(i.NumeroIdentificacion, '') + '"' +
            ',"IDParentezco":"' + dbo.fnAuditoria_ObtenerParentesco(ISNULL(i.IDParentezco, 0)) + ' (' + CAST(ISNULL(i.IDParentezco, 0) AS NVARCHAR(10)) + ')"' +
            ...
            ',"FechaHoraCrea":"' + ISNULL(CONVERT(NVARCHAR(19), i.FechaHoraCrea, 103) + ' ' + CONVERT(NVARCHAR(8), i.FechaHoraCrea, 108), '') + '"' +
            ',"UsuarioModifica":"' + dbo.fnAuditoria_ObtenerUsuario(ISNULL(i.UsuarioModifica, 0)) + ' (' + CAST(ISNULL(i.UsuarioModifica, 0) AS NVARCHAR(10)) + ')"' +
            ',"FechaModifica":"' + ISNULL(CONVERT(NVARCHAR(19), i.FechaModifica, 103) + ' ' + CONVERT(NVARCHAR(8), i.FechaModifica, 108), '') + '"' +
...
PRINT 'Trigger tr_Auditoria_tbBeneficiarios MEJORADO creado exitosamente'
PRINT 'Incluye: descripciones de IDs, formato fechas dd/MM/yyyy y hora AM/PM'
