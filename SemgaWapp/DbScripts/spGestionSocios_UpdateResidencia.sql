-- =============================================
-- Script: Actualizar stored procedures para manejar campos de Residencia
-- Descripción: Modificar SPs para trabajar con campos de residencia usando Code en las relaciones
-- Fecha: 2024
-- =============================================
...
BEGIN
    ...
    INSERT INTO tbAsociados (
        ...
        ProvinciaTrabajo, DistritoTrabajo, CorregimientoTrabajo, PaisResidencia,
        ProvinciaResidencia, DistritoResidencia, CorregimientoResidencia
    ) VALUES (
        @IdTipoAsociado, @Nombre, @SegundoNombre, @Apellido, @SegundoApellido, @Estatus,
        @TipoIdentificacion, @NumeroIdentificacion, @TelefonoResidencia, @TelefonoCelular,
        @TelefonoFamiliar, @CorreoElectronico, @Sexo, @FechaNacimiento, 
...
PRINT '✅ Todos los stored procedures actualizados para manejar campos de Residencia'
GO
